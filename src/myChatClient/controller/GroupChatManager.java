...
public class GroupChatManager {
    ...
    public void go() throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../view/fxml/GroupChatPage.fxml"));
    ...
    public void renderRightList() {
        ...
        if(flag)  GlobalState.groupChatController.commitButton.setStyle("-fx-background-color: rgb(18,150,17); -fx-border-width: 1; -fx-background-radius: 0;");
        else GlobalState.groupChatController.commitButton.setStyle("-fx-background-color: rgb(140,213,140); -fx-border-width: 1; -fx-background-radius: 0;");
    }
